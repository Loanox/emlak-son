...
{
    /// <inheritdoc />
    public partial class Phase11_UserInteraction : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Drop existing tables if they exist to prevent EF Core conflicts.
            migrationBuilder.Sql(@"
                ...
                IF OBJECT_ID('PropertyInquiries', 'U') IS NOT NULL DROP TABLE PropertyInquiries;
            ");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_AppUserId_PropertyId",
                table: "Favorites",
                columns: new[] { "AppUserId", "PropertyId" },
                unique: true);
